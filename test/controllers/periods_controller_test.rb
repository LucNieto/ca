...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { nombre_periodo: @period.nombre_periodo, period_type: @period.period_type, school_cycle_id: @period.school_cycle_id } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { nombre_periodo: @period.nombre_periodo, period_type: @period.period_type, school_cycle_id: @period.school_cycle_id } }
